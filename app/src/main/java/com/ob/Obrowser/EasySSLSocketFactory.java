 ...
 * certificate * * @author olamy * @version $Id: EasySSLSocketFactory.java
 * 765355 2009-04-15 20:59:07Z evenisse * $ * @since 1.2.3
 */
public class EasySSLSocketFactory implements LayeredSocketFactory {
	...
	/**
	 * * @see org.apache.http.conn.scheme.SocketFactory#c
	 * onnectSocket(java.net.Socket, * java.lang.String, int,
